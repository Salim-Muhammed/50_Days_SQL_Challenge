...
INSERT INTO customerss (id, first_name, last_name, city, address, phone_number) VALUES
...
INSERT INTO orderss (id, cust_id, order_date, order_details, total_order_cost) VALUES
...
select --o.*,
	  ...
	  round( sum(case
		   ...
		   end)::numeric/count(*)::numeric *100,2) as per_shipable
from orderss o
...
select --o.*,
	  ...
	  round( sum(case
		   ...
		   end)::numeric/count(*)::numeric *100,2) as per_cust_novalidph
from orderss o
left join customerss c
on o.cust_id = c.id;
